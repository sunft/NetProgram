...
package com.sunft.net.netty.upload;
...
public class HttpUploadServerHandler extends SimpleChannelInboundHandler<HttpObject> {
    ...
    static {
        DiskFileUpload.deleteOnExitTemporaryFile = true; // should delete file
                                                         // on exit (in normal
                                                         // exit)
        DiskFileUpload.baseDirectory = "I:" + File.separatorChar + "aa"; // system temp directory
        DiskAttribute.deleteOnExitTemporaryFile = true; // should delete file on
                                                        // exit (in normal exit)
        DiskAttribute.baseDirectory = "I:" + File.separatorChar + "aa"; // system temp directory
    }
